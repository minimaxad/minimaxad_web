...
const Contact: React.FC = () => {
  return (
    <section id="contact" className="py-16 md:py-24 bg-gradient-to-br from-primary-orange to-primary-teal">
        ...
        <div className="text-center text-white space-y-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg opacity-80 mb-12">
              無料相談では、現在の課題をヒアリングし、最適なソリューションをご提案いたします。<br />
              まずはお気軽にお問い合わせください。
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
            <Link href="/contact" className="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6 hover:bg-opacity-30 transition-all duration-300 group">
            ...
            <Link href="/quote" className="bg-white bg-opacity-20 backdrop-blur-sm rounded-xl p-6 hover:bg-opacity-30 transition-all duration-300 group">
              <svg className="mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
